...
### We are using DetectGPT to judge if a body of text has been AI-Generated

"We find DetectGPT is more discriminative than existing zero-shot methods for model sample detection, notably improving detection of fake news articles generated by 20B parameter GPT-NeoX from 0.81 AUROC for the strongest zero-shot baseline to 0.95 AUROC for DetectGPT." - https://arxiv.org/abs/2301.11305v1 (13.08.23)
